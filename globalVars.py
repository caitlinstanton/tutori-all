...
accountCreationEmail = """Dear %s,
    Stuyvesant High School Arista Association has received a request to create an account with this email address. If you did not make this request, please ignore this email. If you did make this request, you are required to verify your email before your account may be used. To verify your email, please go to https://www.arista.stuycs.org/verify and enter the the verification code below. Please do not share your verification code with anyone else.
